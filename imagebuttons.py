...
im2 = Image.open('/home/toannguyen/Desktop/hello-world/1.png')
im3 = im2.resize((100,100))
with BytesIO() as output:
    im3.save(output, format="PNG")
    blank = output.getvalue()
    
im4 = Image.open('/home/toannguyen/Desktop/hello-world/2.png')
im5 = im4.resize((100,100))
with BytesIO() as output:
    im5.save(output, format="PNG")
    blank1 = output.getvalue()
...
col_files = [[sg.Listbox(values=fnames, change_submits=True, size=(60, 30), key='listbox')],
             [sg.Button('Next', image_data=blank, size=(8, 2)), sg.Button('Prev',image_data=blank1, size=(8, 2)), file_num_display_elem]]
